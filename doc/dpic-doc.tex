...
In cases where the subscripted variable or label is part of a macro
argument, it is wise to protect the comma in the subscript
with parentheses
...
generate output compatible with \LaTeX
in the case of \dpic and \groff or \LaTeX in the case of \gpic.
\Dpic also generates
...
or, in some cases, printed on paper.
...
uses the environmental variable {\tt textoffset}, which is 2\,pt by
